...
type Service interface {
	...
	Begin(query string, args ...interface{}) (*sql.Tx, error)
...
func (s *service) Begin(query string, args ...interface{}) (*sql.Tx, error) {
	return s.db.Begin()
}
...
func New(runMigrations bool, runMigrationsDown bool) Service {
	// Reuse Connection
	if dbInstance != nil {
		return dbInstance
	}
